...
<footer class="when-sm:mt-16 bg-[#1c233e]">
    <div class="container px-4">
        <div class="grid grid-cols-12 gap-5 pt-5 pb-8 min-md:border-b-1 border-[#333951] lg:gap-0 lg:grid-cols-12">
            <div
                class="flex flex-row items-start col-span-12 space-x-3 lg:justify-start justify-evenly lg:flex-col lg:col-span-3 lg:space-x-0">
                <div>
                    <img src="<?php echo $footer['valtes_logo']['url'] ?>"
                        alt="<?php echo $footer['valtes_logo']['alt'] ?>" class="w-32 h-10">
                    <p class="pb-4 mt-5 text-base font-normal text-white md:pr-32">
                        <?php echo $footer['address'] ?>
                    </p>
                </div>
                <div class="p-5 bg-white rounded-full">
                    <img src="<?php echo $footer['label_image']['url'] ?>"
                        alt="<?php echo $footer['label_image']['alt'] ?>" class="h-10 w-28">
                </div>
            </div>
            ...
            <div class="col-span-12 px-2 lg:hidden">
                <button id="valtes_voor"
                    class="flex items-center justify-between w-full px-3 py-4 rounded-lg bg-[#232A44]">
                    <div class="font-semibold text-white">
                        <?php echo $footer['valtes_voor_section']['title'] ?>
                    </div>
                    <div id="down_arrow" class="flex items-center justify-center p-2 bg-[#9195a2] rounded-full"><svg
                    ...
                    <div id="up_arrow" class="hidden items-center justify-center p-2 bg-[#9195a2] rounded-full"> <svg
                            width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M5.97656 1.67187L11.5313 7.22656L11.0156 8.71875L5.97656 3.67969L0.9375 8.71875L0.445313 7.22656L5.97656 1.67187Z"
                                fill="#1C233E" />
                        </svg>
                    </div>
                </button>
            ...
            <div class="flex flex-col col-span-12 lg:col-span-4">
                <h2 class="hidden text-xl font-bold text-white lg:block">
                    <?php echo $footer['download_section']['download_title'] ?>
                </h2>
                <div class="flex flex-col gap-6 mx-auto mt-5 md:mx-0 lg:flex-row">
                    <img src="<?php echo $footer['download_section']['main_image']['url'] ?>"
                        class="lg:w-auto self-center lg:self-auto lg:h-40 w-[60%] h-auto"
                        alt="<?php echo $footer['download_section']['main_image']['alt'] ?>">
                    <div class="flex flex-row items-center gap-6 gap sm:ml-5 lg:flex-col">
                        <div class="flex flex-col gap-3">
                            <a href="<?php echo $footer['download_section']['appstore_link'] ?>">
                                <img src="<?php echo $footer['download_section']['appstore_image']['url'] ?>"
                                    class="lg:w-auto lg:h-8"
                                    alt="<?php echo $footer['download_section']['appstore_image']['alt'] ?>">
                            </a>
                            <a href="<?php echo $footer['download_section']['googleplay_link'] ?>">
                                <img src="<?php echo $footer['download_section']['googleplay_image']['url'] ?>"
                                    class="lg:w-auto lg:h-8"
                                    alt="<?php echo $footer['download_section']['googleplay_image']['alt'] ?>">
                            </a>
                        </div>
                        <img src="<?php echo $footer['download_section']['qr_image']['url'] ?>"
                            class="w-28 lg:w-20 lg:h-20"
                            alt="<?php echo $footer['download_section']['qr_image']['alt'] ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-5 py-6  min-md:border-b-1 border-[#333951] ">
            <div class="flex flex-col items-start justify-between col-span-12 lg:flex-row lg:items-end lg:col-span-3">
                ...
                <a href="<?php echo $footer['contact_us']['link']['url'] ?>"
                    class="mt-5 btn-footer btn-outline md:mt-0">
            ...
            <div
                ...
                <a href="<?php echo $footer['collaboration']['link']['url'] ?>"
                    class="btn-footer btn-outline flex justify-center items-center md:w-[16rem] w-full mt-5 md:mt-0">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#2B37DC"
                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 mr-1">
        ...
        <div class="flex flex-col items-center justify-between pb-5 text-white lg:py-5 lg:flex-row">
            <div class="w-full text-center lg:text-start">
                <p class="px-3 text-sm font-normal lg:text-base">
                    <?php echo $footer['copyright_text'] ?>
                </p>
            </div>
            <div class="items-center justify-end hidden lg:flex w-full">
                <a href="<?php echo $footer['cookie_policy']['url'] ?>" class="px-3 text-base font-normal">
                    <?php echo $footer['cookie_policy']['title'] ?>
                </a>
                <span>/</span>
                <a href="<?php echo $footer['privacy_statement_text']['url'] ?>" class="px-3 text-base font-normal">
