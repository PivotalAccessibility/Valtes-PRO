    ...
    <div class="container flex sm:flex-nowrap flex-wrap justify-between max-w-4xl mx-auto 2xl:max-w-5xl px-5 sm:px-0">
        ...
        <div class="sm:w-[60%] w-full">
            ...
            <div clas="bg-green-200">
                ...
                <a href=""
                    class="flex items-center px-16 py-2 text-sm text-[#2B37DC] border-2 font-semibold border-[#2B37DC] rounded-full w-fit ">
                    <span>
            ...
            <aside class="flex justify-center">
                ...
                <div class="grid grid-row-3 gap-y-5">
                    ...
                    <a href="<?php echo get_permalink(get_the_ID()); ?>"
                        class="sm:w-[18rem] w-full rounded-2xl h-auto bg-white block shadow-lg hover:shadow-xl transition duration-300">
                        <div class="relative">
                            ...
                            <div>
                                <img src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'medium'); ?>"
                                    alt="<?php the_title(); ?>" class="object-cover w-full h-48 rounded-t-2xl">
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between w-full mt-6">
                                ...
                                <div>
                                    <img src="<?php echo get_avatar_url(get_the_author_meta('ID')); ?>"
                                        alt="Author Image" class="w-auto h-5 rounded-full">
                                </div>
                            </div>
                        </div>
                    </a>
