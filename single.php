                    ...
                    <div class="mt-5">
                        ...
                        <ul class="space-y-3 mt-5">
                            ...
                            <li class="flex items-center">
                                <img src="<?php echo valtes_assets('images/DeviceMobile.svg') ?>" alt=""
                            ...
                            <li class="flex items-center">
                                <img src="<?php echo valtes_assets('images/FirstAid.svg') ?>" alt=""
                                    class="h-5 w-5 text-primary">
                            ...
                            <li class="flex items-center">
                                <img src="<?php echo valtes_assets('images/Clock.svg') ?>" alt=""
                                    class="h-5 w-5 text-primary">
                            ...
                            <li class="flex items-center">
                                <img src="<?php echo valtes_assets('images/GpsFix.svg') ?>" alt=""
                                    class="h-5 w-5 text-primary">
