    ...
    <div class="grid grid-cols-1 gap-5 mt-10 md:gap-11 lg:grid-cols-2">
        <?php foreach ($share['cards'] as $card): ?>
            <a href="<?php echo $card['link']['url']; ?>"
                class=" md:w-auto w-full md:rounded-full rounded-t-[60px] rounded-b-3xl border-2 border-jobborder p-2 flex md:flex-row flex-col items-center hover:bg-primaryLight group">
                ...
                <div class="px-5 mt-4 md:mt-0">
                    <h3
                        class="text-base font-bold md:text-xl text-black group-hover:underline group-hover:text-jobborder">
