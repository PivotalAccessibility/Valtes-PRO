...
<section class="bg-primaryLight md:py-20 py-10 md:my-0 my-[3.75rem]">
    <div class="container flex flex-col items-center justify-center re-container">
        ...
        <div class="w-full mt-10 overflow-x-auto">
            <div class="flex grid-cols-1 gap-[1.88rem] md:gap-[6.75rem] pb-5 space-x-5 sm:grid lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 md:space-x-0 md:pb-0 imageSlider">
